      ...
      <header className="topbar">
        <div className="topbar-inner">
          ...
          <nav className="nav">
            ...
            <button className="btn btn-primary" onClick={() => alert("Em breve: matrícula/rematrícula")}>
      ...
      <main className="main">
        <div className="main-inner">
          ...
          <aside className="sidebar">
            ...
            <div className="side-title" style={{ marginTop: 14 }}>Conta</div>
          ...
          <section className="content">
            <div className="hero">
              ...
              <p>
                Aqui você acompanha sua jornada, acessa aulas, faz provas e mantém sua matrícula em dia.
              </p>
              <div style={{ marginTop: 12, fontSize: 14, color: "rgba(255,255,255,0.85)" }}>
                Curso em andamento: <b>{cursoAtual}</b> • Progresso: <b>{progresso}%</b>
              </div>
            </div>
            ...
            <div className="grid">
              <div className="card span-4" id="cursos">
                ...
                <div style={{ marginTop: 12 }}>
                  <button className="btn btn-primary" onClick={() => alert("Em breve: listar cursos do backend")}>
                    Abrir cursos
                  </button>
                </div>
              </div>
              ...
              <div className="card span-4" id="provas">
                ...
                <div style={{ marginTop: 12 }}>
                  <button className="btn btn-primary" onClick={() => alert("Em breve: provas do backend")}>
                    Ver provas
                  </button>
                </div>
              </div>
              ...
              <div className="card span-4" id="boletos">
                ...
                <div style={{ marginTop: 12 }}>
                  <button className="btn btn-primary" onClick={() => alert("Financeiro entra após banco + cursos")}>
                    Ver boletos
                  </button>
                </div>
              </div>
              ...
              <div className="card span-8" id="jornada">
                ...
                <p>Próximo passo: mostrar módulos/aulas e marcar como concluída.</p>
              ...
              <div className="card span-4" id="avisos">
                ...
                <div style={{ marginTop: 10, fontSize: 14, color: "#334155" }}>
                  • Bem-vindo ao portal do aluno<br/>
